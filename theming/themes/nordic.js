...
const textColors = {
  'on-main': Pallet.polar[0],
  'on-main-muted': Pallet.polar[3],
  'on-menu': Pallet.snow[0],
  'on-menu-active': Pallet.snow[2],
  'on-menu-muted': Pallet.polar[3],
...
const hocusColors = {
  ...
  text: {
    ...
    'on-neutral-hocus': Pallet.snow[0],
  }
}
