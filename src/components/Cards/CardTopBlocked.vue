...
const dataRaw = computed(() => apiStore.topBlocked?.top_domains)

const columns: DataTableColumns = [
  { key: 'domain', label: 'Domain', sortable: true },
  { key: 'count', label: 'Hits', sortable: true },
...
<template>
  <CardComponent
    ...
    hasTable
  >
    <div v-if="dataRaw != null && dataRaw != undefined && apiStore.topBlocked.blocked_queries > 0">
      <DataTable
        :rows="dataRaw"
        :columns="columns"
        :filter="false"
